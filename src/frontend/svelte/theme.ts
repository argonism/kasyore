...
export const CustomTheme: CustomThemeConfig = {
    ...
    properties: {
		...
		// =~= Theme Colors  =~=
		// primary | #eaa4c2
		"--color-primary-50": "252 241 246", // #fcf1f6
		"--color-primary-100": "251 237 243", // #fbedf3
		"--color-primary-200": "250 232 240", // #fae8f0
		"--color-primary-300": "247 219 231", // #f7dbe7
		"--color-primary-400": "240 191 212", // #f0bfd4
		"--color-primary-500": "234 164 194", // #eaa4c2
		"--color-primary-600": "211 148 175", // #d394af
		"--color-primary-700": "176 123 146", // #b07b92
		"--color-primary-800": "140 98 116", // #8c6274
		"--color-primary-900": "115 80 95", // #73505f
		// secondary | #4F46E5
